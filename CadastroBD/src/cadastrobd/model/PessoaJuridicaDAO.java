...
public class PessoaJuridicaDAO {
    ...
    public void excluir(int id) throws SQLException {
        ResultSet rs = cnx.getSelect("select idPessoa from Pessoa_Juridica pj  WHERE  pj.idPessoa_Juridica = " + id + ";");
        rs.next();
        int idPessoaAssociadaA_PessoaJuridica = rs.getInt(1);
        String sqlDeletePessoaJuridica = "Delete from Pessoa_Juridica where idPessoa_Juridica = " + id + ";";
