...
public class PessoaFisicaDAO {
    ...
    public void excluir(int id) throws SQLException {
        ResultSet rs = cnx.getSelect("select idPessoa from Pessoa_Fisica pf  WHERE  pf.idPessoa_Fisica = " + id + ";");
        rs.next();
        int idPessoaAssociadaA_PessoaFisica = rs.getInt(1);
        String sqlDeletePessoaFisica = "Delete from Pessoa_Fisica where idPessoa_Fisica = " + id + ";";
